...
public class FilmActorDao extends DAOImpl<FilmActorRecord, FilmActor, Record2<UInteger, UInteger>> {
    ...
    @Override
    public Record2<UInteger, UInteger> getId(FilmActor object) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfJActorId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByJActorId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfJFilmId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByJFilmId(UInteger... values) {
