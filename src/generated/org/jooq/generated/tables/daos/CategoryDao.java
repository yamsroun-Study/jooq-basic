...
public class CategoryDao extends DAOImpl<CategoryRecord, Category, UInteger> {
    ...
    @Override
    public UInteger getId(Category object) {
     ...
     * upperInclusive</code>
     */
    public List<Category> fetchRangeOfJCategoryId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Category> fetchByJCategoryId(UInteger... values) {
     ...
     */
    public Category fetchOneByJCategoryId(UInteger value) {
     ...
     * Fetch a unique record that has <code>category_id = value</code>
     */
    public Optional<Category> fetchOptionalByJCategoryId(UInteger value) {
