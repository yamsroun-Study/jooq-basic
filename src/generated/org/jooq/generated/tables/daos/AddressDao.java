...
public class AddressDao extends DAOImpl<AddressRecord, Address, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Address> fetchRangeOfJAddressId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Address> fetchByJAddressId(UInteger... values) {
     ...
     */
    public Address fetchOneByJAddressId(UInteger value) {
     ...
     * Fetch a unique record that has <code>address_id = value</code>
     */
    public Optional<Address> fetchOptionalByJAddressId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Address> fetchRangeOfJCityId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Address> fetchByJCityId(UInteger... values) {
