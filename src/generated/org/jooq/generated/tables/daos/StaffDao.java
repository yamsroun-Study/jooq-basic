...
public class StaffDao extends DAOImpl<StaffRecord, Staff, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Staff> fetchRangeOfJStaffId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Staff> fetchByJStaffId(UInteger... values) {
     ...
     */
    public Staff fetchOneByJStaffId(UInteger value) {
     ...
     * Fetch a unique record that has <code>staff_id = value</code>
     */
    public Optional<Staff> fetchOptionalByJStaffId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Staff> fetchRangeOfJAddressId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Staff> fetchByJAddressId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Staff> fetchRangeOfJStoreId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Staff> fetchByJStoreId(UInteger... values) {
