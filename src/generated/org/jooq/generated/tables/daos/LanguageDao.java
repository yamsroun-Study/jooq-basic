...
public class LanguageDao extends DAOImpl<LanguageRecord, Language, UInteger> {
    ...
    @Override
    public UInteger getId(Language object) {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfJLanguageId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Language> fetchByJLanguageId(UInteger... values) {
     ...
     */
    public Language fetchOneByJLanguageId(UInteger value) {
     ...
     * Fetch a unique record that has <code>language_id = value</code>
     */
    public Optional<Language> fetchOptionalByJLanguageId(UInteger value) {
