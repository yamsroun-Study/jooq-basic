...
public class CustomerDao extends DAOImpl<CustomerRecord, Customer, UInteger> {
    ...
    @Override
    public UInteger getId(Customer object) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJCustomerId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Customer> fetchByJCustomerId(UInteger... values) {
     ...
     */
    public Customer fetchOneByJCustomerId(UInteger value) {
     ...
     * Fetch a unique record that has <code>customer_id = value</code>
     */
    public Optional<Customer> fetchOptionalByJCustomerId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJStoreId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Customer> fetchByJStoreId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJAddressId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Customer> fetchByJAddressId(UInteger... values) {
