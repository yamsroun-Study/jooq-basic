...
public class FilmCategoryDao extends DAOImpl<FilmCategoryRecord, FilmCategory, Record2<UInteger, UInteger>> {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfJFilmId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByJFilmId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfJCategoryId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByJCategoryId(UInteger... values) {
