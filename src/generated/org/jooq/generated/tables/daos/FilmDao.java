...
public class FilmDao extends DAOImpl<FilmRecord, Film, UInteger> {
    ...
    @Override
    public UInteger getId(Film object) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJFilmId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Film> fetchByJFilmId(UInteger... values) {
     ...
     */
    public Film fetchOneByJFilmId(UInteger value) {
     ...
     * Fetch a unique record that has <code>film_id = value</code>
     */
    public Optional<Film> fetchOptionalByJFilmId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJLanguageId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Film> fetchByJLanguageId(UInteger... values) {
     ...
     */
    public List<Film> fetchRangeOfJOriginalLanguageId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Film> fetchByJOriginalLanguageId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJRentalDuration(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Film> fetchByJRentalDuration(UByte... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJLength(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Film> fetchByJLength(UShort... values) {
