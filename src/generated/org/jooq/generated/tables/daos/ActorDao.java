...
public class ActorDao extends DAOImpl<ActorRecord, Actor, UInteger> {
    ...
    @Override
    public UInteger getId(Actor object) {
     ...
     * upperInclusive</code>
     */
    public List<Actor> fetchRangeOfJActorId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Actor> fetchByJActorId(UInteger... values) {
     ...
     */
    public Actor fetchOneByJActorId(UInteger value) {
     ...
     * Fetch a unique record that has <code>actor_id = value</code>
     */
    public Optional<Actor> fetchOptionalByJActorId(UInteger value) {
