...
import yamsroun.jooqfirstlook.actor.ActorUpdateRequest;
...
public class JooqUpdateTest {
    ...
    void 업데이트_일부_필드만() {
        ...
        // when
        int affectedRows = actorRepository.updateWithDto(newActorId, request);
    ...
    void 업데이트_일부_필드만_with_record() {
        ...
        // when
        int affectedRows = actorRepository.updateWithRecord(newActorId, request);
    ...
    void delete_예제() {
        ...
        // when
        int affectedRows = actorRepository.delete(newActorId);
    ...
    void delete_with_active_record_예제() {
        ...
        // when
        int affectedRows = actorRepository.deleteWithActiveRecord(newActorId);
